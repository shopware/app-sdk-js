...
import { convertRequest, convertResponse, rawRequestMiddleware } from "../../src/framework/express.js";
...
describe('Express', async () => {
    ...
    test('convert response', async () => {
        ...
        expect(expressResponse.header).toHaveBeenCalledWith('content-type', 'application/json');
